...
1.  **Forward Simulation (RK4):**
    ...
    * [View Code: `integrate_trajectory`](src/fit_drag_model.py#L45)
...
3.  **Optimization (Bisection):**
    ...
    * [View Code: `find_optimal_k`](src/fit_drag_model.py#L90)
...
<p align="center">
  <img src="[https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Vortex-street-animation.gif/440px-Vortex-street-animation.gif](https://commons.wikimedia.org/wiki/File:Vortex-street-animation.gif)" alt="Vortex Shedding Animation">
</p>
<p align="center">
